...
public final class CurrentUser {
     ...
     */
    public static final String CURRENT_USER_SESSION_ATTRIBUTE_KEY = "CurrentUser.Userid";

    public static final String CURRENT_USER_SESSION_ROLE_KEY = "CurrentUser.Role";
    ...
    public static String getRole() {
        String currentUserRole = (String) getCurrentRequest().getWrappedSession()
                .getAttribute(CURRENT_USER_SESSION_ROLE_KEY);
    ...
    public static void setRole(String currentUserRole) {
        if (currentUserRole == null) {
            getCurrentRequest().getWrappedSession().removeAttribute(
                    CURRENT_USER_SESSION_ROLE_KEY);
        } else {
            getCurrentRequest().getWrappedSession().setAttribute(
                    CURRENT_USER_SESSION_ROLE_KEY, currentUserRole);
        }
    }
